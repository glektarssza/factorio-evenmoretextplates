...
$local:modName = "even-more-text-plates-2.0";
...
$local:modVersion = Get-Content -Path .\even-more-text-plates-2.0\info.json | Select-String -Pattern '"version": "(.+)"' | Select-Object -ExpandProperty Matches | Select-Object -ExpandProperty Groups | Select-Object -ExpandProperty Captures | Select-Object -Property Value -Last 1 -ExpandProperty Value;
